...
/* Inserting into user */
insert into customer (email, password, name, address_street_num, address_street_name, address_street_postal, phone)
	values ('test.pilot@gmail.com', 'gaben12', 'Gaben', '123', 'Sesame Street', 'K1J6S5', '6137371111');
